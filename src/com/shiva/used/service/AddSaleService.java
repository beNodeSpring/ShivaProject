...
public class AddSaleService implements Service {
	...
	public ServiceForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		used_saleVO boarddata = new used_saleVO();
		...
		try {
			...
			boarddata.setNAME_S(ID);
			boarddata.setSUBJECT_S(multi.getParameter("SUBJECT_S"));
			boarddata.setCONTENT_S(multi.getParameter("CONTENT_S"));
			boarddata.setFILE_S(multi.getFilesystemName((String)multi.getFileNames().nextElement()));
			result = useddao.boardInsert(boarddata);
