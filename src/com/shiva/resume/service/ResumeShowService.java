...
public class ResumeShowService implements Service{
	public ServiceForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//시작
		System.out.println("ResumeShowService 시작합니다.");
		
		//db에서 해당 레주메를 가져옵니다.
		System.out.println("가져올 레주메의 id는 : " + (String)request.getSession(false).getAttribute("id"));
		resume = resumedao.getResume((String)request.getSession(false).getAttribute("id"));
		...
		request.setAttribute("JAVAVAL", resume.getJAVAVAL());
